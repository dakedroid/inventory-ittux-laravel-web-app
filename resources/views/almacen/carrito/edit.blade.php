...
@section ('contenido')
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h3>Prestar carrito:{{$carrito->nombre}}</h3>
			@if (count($errors)>0)
      ...
      {!!Form::model($carrito,['method'=>'PATCH','route'=>['carrito.update',$carrito->clave]])!!}
            {{Form::token()}}
						<table  class="table table-condensed" ALIGN="center" class="row">
						  		<td WIDTH="40%"><div class="form-group">
										<div class="form-group">
                    	<label for="clave">Clave</label>
                    	<input type="text" name="clave" class="form-control" value="{{$carrito->clave}}" placeholder="Clave ...">
                    </div>

										<div class="form-group">
												<label for="clave">Clave</label>
												<input type="text" name="clave" class="form-control" value="{{$carrito->clave}}">
										</div>
										<div class="form-group">
