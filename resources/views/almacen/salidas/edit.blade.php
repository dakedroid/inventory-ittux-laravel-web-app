...
@section ('contenido')
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h3>Prestar salidas:{{$salidas->nombre}}</h3>
			@if (count($errors)>0)
      ...
      {!!Form::model($salidas,['method'=>'PATCH','route'=>['salidas.update',$salidas->num_progre]])!!}
            {{Form::token()}}
                    	...
                    	<input type="text" name="num_progre" class="form-control" value="{{$salidas->num_progre}}" placeholder="Num progre ...">
                    </div>

										<div class="form-group">
												<label for="clave">Clave</label>
												<input type="text" name="clave" class="form-control" value="{{$salidas->clave}}">
										</div>
										<div class="form-group">
										<label for="nombre">Nombre herramienta</label>
										<input type="text" name="nombre" class="form-control" value="{{$salidas->nombre}}" placeholder="Nombre herramienta...">
									</div>
									<div class="form-group">
										<label for="categoria">Categoria</label>
										<select name="categoria" class="form-control">
											<option value="{{$salidas->categoria}}">{{$salidas->categoria}}</option>
										...
										<div class="form-group">
											...
											<input type="text" name="cantidad" class="form-control" value="{{$salidas->cantidad}}" placeholder="Cantidad...">
										</div>

											<div class="form-group">
												<label for="unidad">Unidad</label>
												<select name="unidad" class="form-control">
													<option value="{{$salidas->unidad}}">{{$salidas->unidad}}</option>
													<option>1</option>
													<option>2</option>
													<option>3</option>
													<option>4</option>
